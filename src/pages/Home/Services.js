...
import ConferenceBox from './conference-box';
...
class Services extends Component {
  ...
  render() {
    ...
    console.log('conferences', category);
    return (
      <React.Fragment>
        <section className="section" id="courses">
          <Container>
            ...
            <Row>
              ...
              {category === 'Conferences' ? <ConferenceBox items={items} category={category} /> : <CourseBox items={items} category={category} />}
