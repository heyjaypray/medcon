                        ...
                        <Row className="align-items-center">
                            ...
                            <Col lg="5" md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="login-page bg-white shadow rounded p-4">
                                    ...
                                    <AvForm className="login-form" onSubmit={this.login}>
                                        <Row>
                                            <Col lg="12">
                                                <AvGroup className="form-group position-relative">
                                                    <Label for="email">Your Email <span className="text-danger">*</span></Label>
                                                    <i className="mdi mdi-account ml-3 icons"></i>
                                                    <AvField type="text" onChange={this.handleInputChange} className="form-control pl-5" name="email" id="email" placeholder="Enter Your Email Address" required
                                                        errorMessage=""
                                                        validate={{
                                            ...
                                            <Col lg="12">
                                                <AvGroup className="form-group position-relative">
                                                    ...
                                                    <AvField type="password" onChange={this.handleInputChange} className="form-control pl-5" name="password" id="password" placeholder="Enter password" required
                                                        errorMessage=""
                                                        validate={{
                                            ...
                                            <Col lg="12">
                                                <p className="float-right forgot-pass"><Link to="/forgot-password" className="text-dark font-weight-bold">Forgot password ?</Link></p>
                                                <FormGroup>
