            ...
            <Container>
                <Row>
                    <Col lg="4" xs="12" className="mb-0 mb-md-4 pb-0 pb-md-2" name="footercolumn">
                        <Link className={this.props.isLight ? "logo-footer text-dark" : "logo-footer"} to="#">MedCon<span className="text-primary">.</span></Link>
                        <p className={ this.props.isLight ? "mt-4 text-muted" : "mt-4"}>Start working with MedCon that can provide everything you need to generate awareness, drive traffic, connect.</p>
                ...
                <Row className="align-items-center">
                    <Col sm="6">
                        <div className="text-sm-left">
                            <p className="mb-0">© 2020-2021 MedCon.</p>
                        </div>
                    </Col>
