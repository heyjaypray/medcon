            ...
            <Col lg="3" md="6" key={key} className="mt-4 pt-2">
              <div className="team text-center rounded bg-white pt-3" name="team" id="teambox">
                <div className="position-relative">
                  <img src={candidate.Photos[0].url} className="img-fluid avatar avatar-ex-large rounded-pill shadow" alt=""/>
                ...
                <div className="content pt-3 pb-3">
                  ...
                  <small className="designation text-muted">{candidate.About}</small>
                </div>
              </div>
            </Col>
          )
